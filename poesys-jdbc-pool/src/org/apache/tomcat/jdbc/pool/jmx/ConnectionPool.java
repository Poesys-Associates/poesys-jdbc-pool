...
public class ConnectionPool extends NotificationBroadcasterSupport implements
  ...
  public MBeanNotificationInfo[] getNotificationInfo() {
    ...
    MBeanNotificationInfo[] aug =
      new MBeanNotificationInfo[pres.length + loc.length];
    if (pres.length > 0)
  ...
  public static MBeanNotificationInfo[] getDefaultNotificationInfo() {
    String[] types =
      new String[] { NOTIFY_INIT, NOTIFY_CONNECT, NOTIFY_ABANDON,
                    SLOW_QUERY_NOTIFICATION, FAILED_QUERY_NOTIFICATION,
  ...
  public int getMaxConnectionRetries() {
    ...
    return getPoolProperties().getMaxConnectionRetries();
  }

  @Override
  public void setMaxConnectionRetries(int maxConnectionRetries) {
    getPoolProperties().setMaxConnectionRetries(maxConnectionRetries);
  }
