...
public class DataSourceProxy implements PoolConfiguration {
  ...
  public void setPassword(String password) {
    ...
    this.poolProperties.getDbProperties().setProperty("password",
                                                      this.poolProperties.getPassword());
  }
  ...
  public void setUsername(String username) {
    ...
    this.poolProperties.getDbProperties().setProperty("user",
                                                      getPoolProperties().getUsername());
  }
